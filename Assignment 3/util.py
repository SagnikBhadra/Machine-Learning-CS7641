...
def evaluate_data_helper3(input_data_i, output_data_i, input_j, output_j):
    in_sample_input_split = input_data_i[input_j]
    in_sample_output_split = output_data_i[input_j]
    out_of_sample_input_split = input_data_i[output_j]
    out_of_sample_output_split = output_data_i[output_j]
...
def evaluate_data_helper2(learner, evaluater, average, input_data_i, output_data_i, skfolds):
    ...
    for input_j, output_j in skfolds.split(input_data_i, output_data_i):
        ...
        learner.fit(in_sample_input_split, in_sample_output_split)
        ...
        aevaluater.append(evaluater(out_of_sample_output_split, out_of_sample_split_y_hat, average=average))
        evaluater_in_sample.append(evaluater(in_sample_output_split, in_sample_split_y_hat, average=average))
